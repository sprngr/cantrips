...
name: skill-plan
description: >
  Use when creating or refining `.skill-plan.yaml` with skill-wizard, resolving
  scope/mechanism/tier/target_path choices, or preparing plan input for /skill-forge.
---
